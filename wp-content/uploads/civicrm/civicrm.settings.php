...
if (!defined('CIVICRM_UF_DSN') && CIVICRM_UF !== 'UnitTests') {
  define('CIVICRM_UF_DSN', 'mysql://registrationaglo:u%2A2kDNS6@mysql.registration.agloa.org/registration_agloa_org?new_link=true');
}

// Additional settings generated by installer:
$civicrm_paths['civicrm.private']['path'] = '/home/agloa/registration.agloa.org/wp-content/uploads/civicrm';
$civicrm_paths['wp.frontend.base']['url'] = 'https://registration.agloa.org/';
$civicrm_paths['wp.backend.base']['url'] = 'https://registration.agloa.org/wp-admin/';
$civicrm_setting['domain']['userFrameworkResourceURL'] = 'https://registration.agloa.org/wp-content/plugins/civicrm/civicrm';
...
if (!defined('CIVICRM_DSN')) {
  if (CIVICRM_UF === 'UnitTests') {
    ...
    define('CIVICRM_DSN', 'mysql://registrationaglo:u%2A2kDNS6@mysql.registration.agloa.org/registration_agloa_org?new_link=true');
  }
}
...
$civicrm_root = '/home/agloa/registration.agloa.org/wp-content/plugins/civicrm/civicrm/';
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define('CIVICRM_TEMPLATE_COMPILEDIR', '/home/agloa/registration.agloa.org/wp-content/uploads/civicrm/templates_c');
}
...
if (!defined('CIVICRM_UF_BASEURL')) {
  define('CIVICRM_UF_BASEURL', 'https://registration.agloa.org');
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define('CIVICRM_SITE_KEY', 'A3elxTMqkb38EhTuDzoEOdEBz0rQuDJfPBfGSfzizZQ');
}
...
if (!defined('CIVICRM_CRED_KEYS')) {
  define('_CIVICRM_CRED_KEYS', 'aes-cbc:hkdf-sha256:Cx9LDLuf0vMCN9Du5Xw0u6wkKz1dA2mJng7uxAsAXewM34vSw');
...
if (!defined('CIVICRM_DEPLOY_ID')) {
  define('_CIVICRM_DEPLOY_ID', 'HZocLVLT1zwhFw');
...
if (!defined('CIVICRM_SIGN_KEYS')) {
  define('_CIVICRM_SIGN_KEYS', 'jwt-hs256:hkdf-sha256:Z2XI2gq6OQP39dxOmV6pdhXXMUfipytfOe71Mf5mviYa282ygWEw');
...
// define('CIVICRM_MAIL_LOG', '/home/agloa/registration.agloa.org/wp-content/uploads/civicrm/templates_c/mail.log');
// }
