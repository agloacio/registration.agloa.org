...
* Bug Fix: WP 6.2 - get_page_by_tlte is deprecated [#173](https://github.com/BoldGrid/boldgrid-inspirations/issues/173)
* Update: Update Boldgrid/BGforms dependancy.
...
* Update: Increased image download timeout to 60 seconds.

= 2.7.1 =

Release date: July 8th, 2022

* Update: Updated dependencies (php 7.1).
...
* New feature: Taxonmy per post.
* New feature: Custom headers.
* Update: Updated dependencies.
* Update: Remove page headers on start over.

= 2.6.5 =

Release date: January 25th, 2022

* Update: Several php8 fixes.
* Update: Automated tests run against php 5.6, 7.4, and 8.0
...
* Update: Updated the way blogs are installed via Inspirations.
* Update: Updated the My Inspirations page with links to theme support.
* Update: Updated dependencies.
