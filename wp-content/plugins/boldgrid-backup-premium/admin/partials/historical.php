...
wp_nonce_field( 'bgbkup_historical_version_page', 'bgbkup_historical_version_nonce' );
...
<div class="wrap">
	...
	<h1><?php esc_html_e( 'Historical Versions', 'boldgrid-backup' ); ?></h1>
	...
	<?php echo esc_html( $glossary ); ?>

	<hr />

	<h2>File: <?php echo esc_html( $file ); ?></h2>

	<div id="versions_container">
		<span class="spinner inline"></span>
<?php
	// Translators: 1: Filename.
	printf( esc_html__( 'Searching for all versions of %1$s...', 'boldgrid-backup' ), esc_html( $file ) );
?>
	</div>
